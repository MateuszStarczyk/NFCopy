...
public class IPCBroadcastReceiver extends BroadcastReceiver {
    ...
    public IPCBroadcastReceiver(Context ctx) {
        ...
        ctx.registerReceiver(this, new IntentFilter("com.mateuszstarczyk.nfcopy.daemoncall"), null, handler);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if("ENABLE".equals(action)) {
            ...
            Intent toaster = new Intent("com.mateuszstarczyk.nfcopy.toaster");
